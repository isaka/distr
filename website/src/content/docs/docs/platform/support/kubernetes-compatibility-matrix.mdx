...
slug: docs/platform/kubernetes-compatibility-matrix
sidebar:
  order: 2
---

import ThemedImage from '~/components/util/ThemedImage.astro';
import compatibilityMatrixReportLight from '~/assets/docs/platform/support/distr-compatibility-matrix-report-light.png';
import compatibilityMatrixReportDark from '~/assets/docs/platform/support/distr-compatibility-matrix-report-dark.png';
import compatibilityMatrixGithubAction from '~/assets/docs/platform/support/distr-compatibility-matrix-github-action-new.png';
...
2. A Helm application configured in Distr (see [Create Application](/docs/agents/application/))
3. A GitHub repository containing your Helm chart
4. The [Automatic Deployments from GitHub](/docs/integrations/github-actions/) workflow already configured — this guide extends that pipeline with a compatibility validation stage
...
- **[Automatic Deployments from GitHub](/docs/integrations/github-actions/)** — If you haven't already, set up automatic version creation and deployment updates
- **[Application Entitlements](/docs/platform/application-entitlements/)** — Control which customers can access specific application versions and their compatibility reports
- **[Configuring Helm Charts for Distr](/docs/agents/helm-registry-auth/)** — Set up authenticated image pulls with imagePullSecrets
