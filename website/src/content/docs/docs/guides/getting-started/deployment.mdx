...
<Aside type="note">
  If you're using application entitlements, make sure you've created the customer
  organization and assigned the entitlement before creating a deployment. Customers
  will only see applications they have entitlements for.
</Aside>
...
<Aside type="tip">
  ...
  customer doesn't have an entitlement for that application - You need to create an
  [application entitlement](/docs/guides/application-entitlements/) and assign it to
  the customer first
</Aside>
