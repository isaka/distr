...
<Aside>
  We are currently working on an agent version that can be integrated into the Software or AI companies'
  Helm chart or Docker Compose file. This will allow for a more seamless
  deployment experience for the end customer. For more information feel free to
  reach out.
</Aside>
